...
const TEAM_SEED = [
  ...
  { id: 'u-pm', username: 'pablo',    password: 'Pablo2026',     perms: 'admin',                       name: 'Pablo Machado',    initials: 'PM', role: 'Director analista de crédito',       units: ['consultora','maximus'], color: '#14b8a6' },
